...
def main():
    st.set_page_config(
        ...
        page_icon="https://github.com/RodrigoMasterDS/EBAC_Cientista_de_Dados/blob/main/Modulo_19_StreamlitII/Exercicio01/img/telmarketing_icon.png?raw=true",
        layout="wide",
        initial_sidebar_state="expanded",
    )

    # URL da imagem
    image_url = 'https://raw.githubusercontent.com/RodrigoMasterDS/EBAC_Cientista_de_Dados/refs/heads/main/Modulo_19_StreamlitII/Exercicio01/img/Bank-Branding.jpg'
    ...
    <div style="text-align:center">
        <a href="https://github.com/RodrigoMasterDS/EBAC_Cientista_de_Dados">
        <img src="https://github.com/RodrigoMasterDS/EBAC_Cientista_de_Dados/blob/main/ebac_logo-data_science.png?raw=true" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data:** 11 de janeiro de 2024.
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/RodrigoMasterDS/EBAC_Cientista_de_Dados/refs/heads/main/Modulo_19_StreamlitII/Exercicio01/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
