...
print('Aluno: Rodrigo Pacheco')
print('Data: 16 de outubro de 2023.\n')
...
for mes in sys.argv[1:]:
    sinasc = pd.read_csv(
        f'https://raw.githubusercontent.com/RodrigoMasterDS/Rodrigo-EBAC-DS/main/Mo%CC%81dulo%2014%20-%20Scripting/database/SINASC_RO_2019_{mes}.csv')
